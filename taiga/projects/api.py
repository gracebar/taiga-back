...
from taiga.base.api.mixins import OptionalFieldsMixin
...
## Project
######################################################
class ProjectViewSet(LikedResourceMixin, HistoryResourceMixin, ModelCrudViewSet, OptionalFieldsMixin):
